...
<<<<<<< Updated upstream:frontend/src/scripts/components/operations/operations-list.js
=======
...
>>>>>>> Stashed changes:frontend/src/scripts/components/operations/operations-list.ts
    }
}