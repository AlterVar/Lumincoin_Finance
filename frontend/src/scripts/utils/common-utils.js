...
export class CommonUtils {
    static getOperationType(operationType) {
        let typeHtml = null;
    ...
    static getFilterType(filterValue) {
        let filterType = null;
        switch (filterValue) {
            case 'Сегодня' :
    ...
    static generateTools(entity, id) {
        return '<div id="tools_' + id + '" class="d-flex justify-content-end gap-2">' +
            '<button id="'+ id + '" class="delete btn p-0" data-bs-toggle="modal" data-bs-target="#delete-btn">' +
